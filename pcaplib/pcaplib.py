...
class Packet:
    ...
    def strip_link_header(self) -> None:
        "Strip off the link header and set ethertype"
        # XXX This assumes this an Ethernet II frame!
        # It's all I've tested with.
        buff = self.data[12:14]
            ...
            if not pkt:
                ...
                if pkt.ethertype == 0x800:
                    ...
                    if prot == 6:
                        ...
                        print(f'TCP port: {dgram.src} -> {dgram .dst}  '
                              f'flags: {flags}')
